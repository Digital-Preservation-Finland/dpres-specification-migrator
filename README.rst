...
* ``--contractid``: the value of the contract ID (mandatory when migrating to
  version 1.7.2 of the specifications from an older version)
...
1.7.2 of the specifications of the Finnish National Digital Preservation
Services. The updated file is written into the workspace directory.
The 'contractid' argument is mandatory when migrating to version '1.7.2'.
